<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Cancel Lesson - Instructor Illness') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-6 bg-red-50 dark:bg-red-900/20 p-4 rounded-lg border border-red-100 dark:border-red-900/30">
                        ...
                        <p class="text-sm text-red-700 dark:text-red-400">
                            You are about to cancel this lesson due to instructor illness. This will send an automated email notification to the customer.
                            This action cannot be undone.
                        </p>
                    </div>

                    <form method="POST" action="{{ route('instructor.communication.illness.send', $reservation) }}">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="additional_notes" name="additional_notes" rows="4" class="block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:text-white"></textarea>
